 ...
 */
public class IMEIAdapter extends RecyclerView.Adapter<IMEIAdapter.MyViewHolder> {

    private Context mContext;
    private ArrayList<String> IMEIArrayList;
    RecyclerView recyclerView;
    View rootView ;
    public class MyViewHolder extends RecyclerView.ViewHolder {
        public TextView IMEINo;
        public RelativeLayout imei_item;

        public MyViewHolder(View view) {
            super(view);
            IMEINo = (TextView) view.findViewById(R.id.imei_no);
            imei_item = (RelativeLayout) view.findViewById(R.id.parent_rlv);
        }
    }


    public IMEIAdapter(Context mContext, ArrayList<String> IMEIArrayList) {
        this.mContext = mContext;
        this.IMEIArrayList= IMEIArrayList;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.imei_single_item, parent, false);
...
//        itemView.setLayoutParams(params);
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        try {
            final String IMEINo = IMEIArrayList.get(position);
            holder.IMEINo.setText(IMEINo);

            holder.imei_item.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    AlertDialog.Builder builder =
                            new AlertDialog.Builder(mContext, R.style.AppCompatAlertDialogStyle);
                    builder.setTitle("Imei No");
                    builder.setMessage(IMEINo);
                    builder.show();
